// Creates the 3 databases (if they don't exist yet) and runs each schema.sql.
// Run it with:  npm run db
// (running it again resets all 3 databases back to the sample data)
const fs = require("fs");
const path = require("path");
const { Client } = require("pg");
const dotenv = require("dotenv");

const variations = ["1-studynotes", "2-libraryhub", "3-stockroom"];
